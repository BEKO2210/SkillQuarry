#!/usr/bin/env python3
"""Run the suite and report line coverage of skillquarry.py.
...
def main() -> int:
    ...
    print()
    print(f"coverage: skillquarry.py {percent:.1f}%  "
